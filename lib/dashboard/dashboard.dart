          ...
          return SafeArea(
            child: Scaffold(
              ...
              bottomNavigationBar: PersistentTabView(
                ...
                backgroundColor: Helper.getBottomNavigationColor(context).backgroundColor!,
  ...
  List<PersistentBottomNavBarItem> _navBarsItems() {
    return [
      PersistentBottomNavBarItem(
        ...
        title: "Overview",
        activeColorPrimary: Helper.getBottomNavigationColor(context).selectedItemColor!,
        inactiveColorPrimary: Helper.getBottomNavigationColor(context).unselectedItemColor!,
